 ...
 * @author      CedCommerce Core Team <coreteam@cedcommerce.com>
 */
class Ced_CsMarketplace_Block_Vshops_List_Toolbar extends Mage_Core_Block_Template
{
    /**
     * Products collection
     *
     ...
     * @var array
     */
    protected $_defaultAvailableLimit  = array(5=>5,10=>10,20=>20,50=>50);
    ...
    {
        parent::_construct();
        $this->_orderField  = $this->_getConfig()->getDefaultSortBy();
    ...
    protected function _getAvailableLimit($mode)
    {
        ...
        $perPageValues = $this->_defaultAvailableLimit;
        $perPageValues = array_combine($perPageValues, $perPageValues);
		//print_r(($perPageValues + array('all'=>$this->__('All'))));die;
