...
/**
 * Block for csmarketplace categories
 */
class Ced_CsMarketplace_Block_Adminhtml_System_Config_Frontend_Vproducts_Categories extends Mage_Adminhtml_Block_Catalog_Category_Tree
{
    ...
    {
    	$values='';
    	$values = Mage::getStoreConfig('ced_vproducts/general/category');
    	$values = trim($values,',');
    ...
    {
        return $this->getUrl('adminhtml/adminhtml_vproducts/categoriesJson', array('_secure'=>true,'_nosid'=>true,'_current' => true));
    }
